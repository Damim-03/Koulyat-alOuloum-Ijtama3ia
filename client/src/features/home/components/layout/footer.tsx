  ...
  return (
    <footer dir={dir} className="relative font-body">
      ...
      <div className="relative overflow-hidden bg-forest-deep text-cream">
        ...
        />
        <div className="pointer-events-none absolute right-[5%] top-10 size-72 rounded-full border border-white/3" />
        <div className="pointer-events-none absolute bottom-20 left-[8%] size-48 rounded-full border border-white/2" />
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-8 pt-14 lg:px-8">
          <div className="mb-12 flex items-start justify-between">
            ...
            <button
              onClick={scrollTop}
              className="group flex shrink-0 items-center gap-2 rounded-lg border border-white/10 px-3 py-2 text-cream/40 transition hover:border-white/20 hover:bg-white/5 hover:text-cream"
          ...
          <div className="mb-14 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="flex items-center gap-2">
                {SOCIALS.map(({ icon: Icon, href }, i) => (
                  <a
                    ...
                    className="grid size-8 place-items-center rounded-lg border border-white/6 bg-white/6 text-cream/30 transition hover:border-white/12 hover:bg-white/10 hover:text-cream"
                  >
                    <Icon size={14} />
                  </a>
                ))}
            ...
            <div>
              ...
              <div className="mt-5 border-t border-white/6 pt-4">
                <p className="mb-2.5 text-[10px] font-semibold uppercase tracking-widest text-cream/20">
                  {t("footer.official")}
                </p>
                {official.map((l) => (
                  <a
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="mt-0.5 grid size-8 shrink-0 place-items-center rounded-lg bg-white/5">
