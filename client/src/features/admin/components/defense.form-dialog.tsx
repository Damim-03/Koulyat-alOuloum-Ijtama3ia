...
export function DefenseFormDialog({ open, onClose }: Props) {
  ...
  return (
    ...
    >
      <form id="defense-form" onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <Field
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <Field label={t("admin.room")} icon={MapPin} error={errors.room?.message}>
            <input
              {...register("room")}
              className={inputClass}
