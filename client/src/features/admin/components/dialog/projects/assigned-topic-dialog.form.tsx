...
import { useCreateAssignedTopic, useProfessors, useFaculties, useDepartments, useFilieres, useSpecializations, useAcademicYears, useStudents } from "../../../hooks/admin-hook";
