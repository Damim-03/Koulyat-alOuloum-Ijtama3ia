...
import { useCreateDomain, useUpdateDomain } from "../hooks/admin-hook";
...
export function DomainFormDialog({
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    const payload = { name: trimmedName, code: trimmedCode, departmentId };
      ...
      >
        <div className="mb-5 flex items-center justify-between">
          <h2 className="font-serif text-lg font-bold text-forest">
            {isEdit ? t("admin.editDomain") : t("admin.newDomain")}
          </h2>
          <button
            onClick={onClose}
