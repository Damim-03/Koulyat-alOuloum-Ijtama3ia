...
import { Users, ListChecks, CalendarCheck, ChevronLeft } from "lucide-react";
          ...
          {projects.map((p) => {
            ...
            return (
              ...
              >
                ...
                {/* Topic */}
                <h3 className="mb-3 text-start font-serif text-base font-bold text-forest">
                  {p.topic?.title ?? "\u2014"}
                </h3>
                ...
                <div className="mb-3 flex items-center justify-end gap-2">
                  ...
                  <div className="grid size-7 place-items-center rounded-full bg-linear-to-br from-forest to-forest-deep text-[10px] font-bold text-cream">
                    {initials(
                      p.topic?.professor?.user?.firstName,
                      p.topic?.professor?.user?.lastName,
                    )}
                  </div>
                </div>
